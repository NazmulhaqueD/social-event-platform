...
const Banner = () => {
    return (
        <div className='bg-base-300 rounded-2xl relative'>
            <div>
                <img src={'https://i.postimg.cc/wjdgJHwc/pexels-cottonbro-6591147.jpg'}
                    className='w-full h-60 md:h-[500px] lg:h-[700px] rounded-2xl'
                    alt="" />
            </div>
            <div className='text-center p-4 md:absolute md:top-8 md:left-1/2 md:transform md:-translate-x-1/2 nd:-translate-y-1/2'>
                ...
                <p className='text-sm md:text-white md:text-xl md:font-semibold'>Join, Create, and Track Events that make a difference in your local area.</p>
