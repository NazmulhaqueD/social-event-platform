...
const AsideDash = () => {
    return (
        <div className=''>
            <h1 className='text-2xl font-bold text-primary mb-16'><NavLink to={'/'}>Social Events</NavLink></h1>
            ...
            <div className=' flex flex-col gap-6 asideDash'>
                ...
                <NavLink to={'/myEvents'} className={'flex items-center gap-2 font-semibold'}><MdTipsAndUpdates /> <span>My Events</span></NavLink>
