...
const UpcomingEvents = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto min-h-[75vh] p-4 rounded-xl my-6'>
            ...
            <div className={`${isFormView ? 'hidden' : 'block'} grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6`}>
                {
